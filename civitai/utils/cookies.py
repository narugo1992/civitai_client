...
def save_cookies(cookies: Mapping[str, str], file: str):
    with open(file, 'w', encoding='utf-8') as f:
        json.dump(cookies, f, ensure_ascii=False, indent=4, sort_keys=True)


def push_cookies_to_hf(cookies: Mapping[str, str], repository: str, file: str = 'civitai_cookies.json',
